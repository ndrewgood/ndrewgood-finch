...
<footer
	class="fixed inset-x-0 bottom-0 z-0 flex flex-col items-center justify-center gap-3 bg-blue-500"
...
>
	...
	<p class="text-md font-display text-blue-300">
		...
		<button
			type="button"
			class="cursor-pointer underline decoration-1 underline-offset-3 hover:text-white transition-all duration-150 ease-out-cubic"
